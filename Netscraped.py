...
╚═╝╚═╝  ╚═══╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝╚═╝  ╚═══╝  ╚══════╝╚══════╝╚══════╝╚══════╝    ╚═╝
                                       ...
                                       Author: Manuel e Luis
                                       Version: 69.05 (Do cuaralho)

  ####################################### DISCLAIMER ###########################################
  |A utilização do nome Benfica é meramente designativa do nome do clube Sport Lisboa e Benfica|
  |e não pressupõe nenhuma utilização oficial ou associação do serviço ao nome do clube.       |  
  ##############################################################################################
...
searchterm2 = input('Enter Shodan search term: ')
